...
| `03_baseline_models.ipynb`             | Modelos tradicionales BoW/TF-IDF                                                                         |
| `04_linguistic_features.ipynb`         | Features lingüísticas interpretables (spaCy + VADER, LR sin scaler)                                      |
| `05_embeddings_and_transformers.ipynb` | Embeddings (GloVe + Word2Vec) y DistilBERT con grilla HP                                                 |
| `06_feature_importance.ipynb`          | Importancia de atributos y análisis de adjetivos por clase                                               |
| `07_error_analysis.ipynb`              | Análisis manual de errores (falsos positivos / falsos negativos)                                         |
